...
const {
    project_attachment:projectAttachmentModel,
...
const createAttachment = async(req, res) => {
    ...
    const findData = await projectModel.findOne({
        where:{
            uuid
        }
    });
    ...
    const file_link = `/attachment/project/${file_name}`;
    ...
    file.mv(`./public/attachment/project/${file_name}`, async(err)=>{
...
const deleteAttachment = async(req, res) => {
    ...
    const findData = await projectAttachmentModel.findOne({
        where:{
            uuid
        }
    })
