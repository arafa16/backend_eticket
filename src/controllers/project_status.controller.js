const {project_status:projectStatusModel} = require('../models');
...
const getDatas = async(req, res) => {
    ...
    const result = await projectStatusModel.findAndCountAll({
        where:queryObject,
        limit,
        offset,
        order:[sortList]
...
const getDataSelect = async(req, res) => {
    ...
    const result = await projectStatusModel.findAll({
        where:{
            is_select:true,
            is_delete:false
        }
...
const getDataByUuid = async(req, res) => {
    ...
    const result = await projectStatusModel.findOne({
        where:{
            uuid
        }
    });
...
const createData = async(req, res) => {
    ...
    const result = await projectStatusModel.create({
        name,
        sequence,
        is_select,
        is_active
...
const updateData = async(req, res) => {
    ...
    const findData = await projectStatusModel.findOne({
        where:{
            uuid
        }
    })
