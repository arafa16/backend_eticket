const {project_type:projectTypeModel} = require('../models');
...
const getDatas = async(req, res) => {
    ...
    const result = await projectTypeModel.findAndCountAll({
        where:queryObject,
        limit,
        offset,
        order:[sortList]
...
const getDataSelect = async(req, res) => {
    ...
    const result = await projectTypeModel.findAll({
        where:{
            is_select:true,
            is_delete:false
        }
...
const updateData = async(req, res) => {
    ...
    const findData = await projectTypeModel.findOne({
        where:{
            uuid
        }
    })
